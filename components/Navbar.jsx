...
export default function Navbar() {
    ...
    return (
        <nav className={`flex items-center justify-between fixed z-50 top-0 w-full px-6 md:px-16 lg:px-24 xl:px-32 py-4 ${openMobileMenu ? '' : 'backdrop-blur'}`}>
            <a href="/">
                <Image className="h-9 md:h-9.5 w-auto shrink-0 rounded-full" src={theme === "dark" ? "/Akshith.png" : "/Akshith.png"} alt="Logo" width={140} height={40} priority fetchPriority="high" />
            </a>
